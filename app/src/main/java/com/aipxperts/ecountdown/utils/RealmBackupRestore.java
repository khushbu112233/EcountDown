...
import static com.aipxperts.ecountdown.Activity.DashBoardActivity.config;
...
public class RealmBackupRestore {
    ...
    private String EXPORT_REALM_FILE_NAME = "ecountdown.realm";
    ...
    public void backup() {
        ...
        Log.d(TAG, "Realm DB Path = " + realm1.getPath());
        ...
        realm1.writeCopyTo(exportRealmFile);
    ...
    public File dbPath(){
        return new File(EXPORT_REALM_PATH, EXPORT_REALM_FILE_NAME);
    }
