...
public class SettingFragment extends Fragment  implements BillingProcessor.IBillingHandler{
       ...
       /* if(!Pref.getValue(context, "is_remove_ads","").equalsIgnoreCase(""))
        ...
        mBinding.holidaySwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                if (isnotify.equalsIgnoreCase("0")) {
    ...
    private void dialog() {
       ...
       /* List<String> stringList=new ArrayList<>();  // here is list
        for(int i=0;i<3;i++) {
            if(i==0) {
                stringList.add("On the day ");
            }
            if(i==1)
            {
                stringList.add("One day before ");
            }
            if(i==2)
            {
                stringList.add("One week before ");
            }
        }*/
        final RadioGroup rg = (RadioGroup) dialog.findViewById(R.id.radio_group);
       /* RadioButton rb0 = (RadioButton)dialog.findViewById(R.id.radio0);
        RadioButton rb1 = (RadioButton)dialog.findViewById(R.id.radio1);
        RadioButton rb2 = (RadioButton)dialog.findViewById(R.id.radio2);
*/
      ...
      /*  for(int i=0;i<stringList.size();i++){
        ...
        rg.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                //context.registerReceiver(myReceiver, new IntentFilter("android.intent.action.TIME_TICK"));
        ...
        ok.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (is_radiobutton==0){
                    ...
                    Pref.setValue(context, "is_notify", isnotify);
                    mBinding.holidaySwitch.setBackgroundResource(R.mipmap.switch_on);
                    //  ((DashBoardActivity) getActivity()).unregisterMyreceiver();

                    // ((DashBoardActivity)getActivity()).startAlarm(Pref.getValue(context, "event_day_before", 0));
                    dialog.dismiss();
                }
                //((DashBoardActivity)context).NotifyEvent();
            }
        });
        dialog.show();
