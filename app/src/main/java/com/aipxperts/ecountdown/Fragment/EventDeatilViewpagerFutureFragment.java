...
public class EventDeatilViewpagerFutureFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Pref.setValue(context,"from_tab","future");


        mCardAdapter = new CardPagerAdapter(context,eventArrayList_future,"Future");

        for (int j = 0; j < eventArrayList_future.size(); j++) {
            mCardAdapter.addCardItem(eventArrayList_future.get(j).getEvent_image());
        }
...
//        mFragmentCardShadowTransformer.enableScaling(true);
        ...
        mBinding.viewPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                ((DashBoardActivity)context).mBinding.includeHeader.txtTitle.setText(eventArrayList_future.get(position).getEvent_name());
            }
            ...
            for (int cat = 0; cat < event.size(); cat++) {
                ...
                try {
                    ...
                    if (numOfDays<0) {
                        ...
                        eventArrayList_future.add(events1[cat]);
                    }
